...
bool OGL_InitContext()
{
    ...
    if (!s_sdl_context)
    {
        g_ef->log_info(L"OpenGL ES 2.0 context unavailable; falling back to desktop OpenGL.");
        SDL_GL_SetAttribute(SDL_GL_CONTEXT_MAJOR_VERSION, 2);
    ...
    g_ef->log_info(OGL.isGLES ? L"TASVideo: running on an OpenGL ES 2.0 context."
...
void OGL_DrawLine(SPVertex *vertices, int v0, int v1, float width)
{
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        OGL.vertices[i].color.r = color.r;
        OGL.vertices[i].color.g = color.g;
        OGL.vertices[i].color.b = color.b;
        OGL.vertices[i].color.a = color.a;
        ...
        if (OGL.EXT_secondary_color)
        {
            ...
            OGL.vertices[i].secondaryColor.r = color.r;
            OGL.vertices[i].secondaryColor.g = color.g;
            OGL.vertices[i].secondaryColor.b = color.b;
        }
                          ...
                          bool flip)
{
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        if (OGL.EXT_secondary_color)
        {
            OGL.vertices[i].secondaryColor.r = rect[0].secondaryColor.r;
            OGL.vertices[i].secondaryColor.g = rect[0].secondaryColor.g;
            OGL.vertices[i].secondaryColor.b = rect[0].secondaryColor.b;
        }
    }
